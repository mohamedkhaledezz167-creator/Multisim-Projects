# Multisim-Projects
A collection of schematic captures and simulations for various analog circuits, including amplifiers, power supplies, and filter stages, developed in NI Multisim.

# Analog Circuit Design (NI Multisim)
...
* **Virtual Instruments:** Heavy use of the Bode Plotter, Logic Analyzer, and Wattmeter for system verification.
